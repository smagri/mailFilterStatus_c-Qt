...
**
** Created: Tue Aug 2 17:49:23 2011
...
public:
    ...
    void setupUi(QWidget *MailFilterStatus)
    {
        ...
        MailFilterStatus->resize(164, 174);
        MailFilterStatus->setMinimumSize(QSize(164, 174));
        MailFilterStatus->setMaximumSize(QSize(164, 174));
